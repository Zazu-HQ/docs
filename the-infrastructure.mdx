...
Use .com domains. Everything else (.io, .net, etc.) typically sees lower deliverability rates and trust scores. For more on picking the best domains for cold email, [read here](https://www.za-zu.com/blog/cold-email-domains-guide).

Once you buy the domains, you should 301 redirect them to your main domain. For example, if I bought withaurora.com, I’d redirect it to helloaurora.com, our actual doEverything else (.io, .net, etc.) typically sees lower deliverability rates and trust scores.main. You do this so that if someone who sees your email decides to copy and paste your domain into their browser (this is common), they hit your real website. You’d be surprised by how few people are surprised when domains redirect this way, or even notice it. It’s less of a problem than you probably think.
...
These three acronyms, while they look rather scary, are easy to set up and provide some of the basic foundations for work we'll do later. [Here is how to set up each.](https://www.za-zu.com/blog/domain-set-up)
...
If you aren’t interested in learning more of the workings of email warming, [skip to the next section](/writing-great-emails) where we cover evidence-backed methods for writing a great cold email.
