...
<Tip>Use .com domains. Everything else (.io, .net, etc.) typically sees lower deliverability rates and trust scores. For more on picking the best domains for cold email, [read here](https://www.za-zu.com/blog/cold-email-domains-guide).</Tip>
