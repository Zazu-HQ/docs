...
There are some people who believe that most unsolicited outreach is spam by default. When we published [our cold outbound handbook](/handbook/cold-email/intro), for example, we got a broad range of reactions. People on X and LinkedIn generally [loved it](https://x.com/kazanjy/status/1865532800033755192?s=46), but people on HackerNews [hated it](https://news.ycombinator.com/item?id=42357273). The belief of the latter group is that all cold email is spam, and so any tool that enables more cold email is a net negative.
