...
> Curious — if you had a way to spot what’s hot right now and turn it into posts faster (so you can keep that momentum up), would that be useful? That’s exactly what we’ve built at [Social Champ](https://socialchamp.com).
> <br/>
><br/>Cheers,<br />
