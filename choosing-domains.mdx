...
When it comes to cold email success, your domain names matter more than you might think. They're among the first things email providers and recipients use to judge whether you're a trustworthy sender. While domain setup is just one piece of a [successful cold email strategy](/handbook), it's often the make-or-break factor in whether your emails reach the inbox at all.
...
- [Setting up SPF, DMARC, and DKIM records](/handbook/domain-setup)
