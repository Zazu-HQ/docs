...
**So how do you write?** Everything you’ve read so far has prepared you to write—now just start drafting. In the section below, I’ll leave some examples of emails that have performed well for [Aurora](helloaurora.com), so you can get some inspiration for what a good cold email might look like. Remember, though, that your email should be perfect for the person you are emailing, and that examples you see online might not reflect what will work for you.
