...
sidebarTitle: "Why Cold Email Works"
"og:title": "Why Cold Email Works So Well | The Cold Email Handbook"
"og:image": "/images/handbook.jpg"
description: "Why cold email is a high-ROI growth channel, when it works, and the principles behind campaigns that drive pipeline."
mode: "wide"
---

import Newsletter from '/snippets/newsletter.mdx'

<div style={{ maxHeight: '400px', display: 'block', marginBottom: '20px' }}>
  <img 
    src="/images/why-cold-email-works-so-well-header.png"
    alt=""
    style={{ maxHeight: '100%', width: 'auto', objectFit: 'cover', display: 'block' }}
  />
</div>
...
<div className='mb-2'>If you'd like more insights on cold outbound then drop your email in the box below to get an email every time we post a new piece about cold email. No spam, just insights to help you send more effective outbound.</div>
<Newsletter />
</div>
</Frame>

Next chapter starts here → [The Infrastructure](/handbook/cold-email/the-infrastructure)