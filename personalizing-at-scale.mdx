...
>
>Congrats on the recent raise <IfNode></IfNode> investor_list contains "YC" THEN (<VariableNode>investor_name</VariableNode> also funded a previous company of mine, was generally helpful. ELSE ENDIF
>
