...
>
>Congrats on the recent raise <IfNode></IfNode><VariableSelect>investor_list</VariableSelect><Comparison>contains</Comparison><Comparison>YC</Comparison><ThenNode></ThenNode> (<VariableNode>investor_name</VariableNode> also funded a previous company of mine, was generally helpful. ELSE ENDIF
>
