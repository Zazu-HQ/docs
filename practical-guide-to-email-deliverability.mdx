...
For an account (and a domain! this section is not exclusive) to be recognized as credible, it needs to have normal, human-like patterns of engagement. The best way to get human-like patterns of engagement for a new account is to do something called [email warming](/handbook/cold-email/the-infrastructure#warming-your-email-inboxes).
